...
def get_args_parser():
    ...
    parser.add_argument('--num_triplets', default=200, type=int,
                        help="Number of query slots")
    parser.add_argument('--num_relations', default=200, type=int,
                        help="Number of query slots")
    ...
    parser.add_argument('--ann_path', default='', type=str)
...
def main(args):
    ...
    test_file_path = os.path.join(args.output_dir, "test_checkpoint.txt")
    with open(test_file_path, "w") as f:
        f.write("This is a test checkpoint file.")
    ...
    dataset_train = build_dataset(image_set='train', args=args)#57723
